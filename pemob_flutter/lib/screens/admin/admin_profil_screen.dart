...
class _AdminProfilScreenState extends State<AdminProfilScreen> {
  ...
  // ── Pilih foto, salin ke folder permanen, simpan path ──
  Future<void> _pickPhoto() async {
    ...
    // Salin ke folder permanen supaya path tidak berubah
    final uid = SessionUser.currentUser?.uid ?? 'unknown';
    ...
    if (mounted) {
      setState(() => _photoFile = permanentFile);
    }
  }
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(14),
                        border:
                        Border.all(color: _navyDark.withOpacity(0.3)),
                      ),
                      child: const Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                  ...
                  const SizedBox(height: 12),
                  _sectionCard(
                      'Informasi Sistem', Icons.info_outline_rounded, [
