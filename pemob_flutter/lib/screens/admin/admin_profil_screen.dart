...
class _AdminProfilScreenState extends State<AdminProfilScreen> {
  ...
  // Normalise gender value supaya tidak crash dropdown
                  ...
                  _sectionCard(
                    ...
                    children: [
                      _infoRow(Icons.storefront_outlined,
                          'Pasar', 'Pasar Wadungasri, Sidoarjo'),
                      _divider(),
                      _infoRow(Icons.verified_outlined,
                          'Versi App', 'SIPESEL v1.0.0'),
                      _divider(),
                      _infoRow(Icons.cloud_outlined,
