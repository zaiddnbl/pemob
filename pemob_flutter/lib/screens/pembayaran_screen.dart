...
class _PembayaranScreenState extends State<PembayaranScreen> {
  ...
  final List<Map<String, dynamic>> _jenisPajak = [
    {'key': 'harian', 'label': 'Harian', 'icon': Icons.today_rounded, 'harga': 5000, 'durasi': '+1 hari'},
    {'key': 'mingguan', 'label': 'Mingguan', 'icon': Icons.date_range_rounded, 'harga': 35000, 'durasi': '+7 hari'},
    {'key': 'bulanan', 'label': 'Bulanan', 'icon': Icons.calendar_month_rounded, 'harga': 150000, 'durasi': '+30 hari'},
  ];
  ...
  void _generateQRIS() {
    ...
    setState(() {
      _qrisData =
      'SIPESEL|$noTransaksi|$noKios|$_selectedJenis|${_hargaSekarang.toInt()}';
      _showQRIS = true;
    });
  }
                    ...
                    Wrap(
                      ...
                      children: _metodeList.map((m) {
                        ...
                        return GestureDetector(
                          onTap: () =>
                              _onMetodeChanged(m['key'] as String),
                          child: AnimatedContainer(
                        ...
                        Center(
                          child: Column(
                            children: [
                              ...
                              Text(
                                  'Total: Rp ${_formatRupiah(_hargaSekarang)}',
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _ringkasanRow('Jenis Retribusi',
                        _jenisPajak.firstWhere((j) =>
                        j['key'] == _selectedJenis)['label'] as String),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _row('Jam',
                      p.tanggal.length >= 16 ? p.tanggal.substring(11, 16) : '-'),
