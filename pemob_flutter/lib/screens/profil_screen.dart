...
class _ProfilScreenState extends State<ProfilScreen> {
  static const Color _color = AppTheme.primaryGreen;
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: Text('Profil', style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w700)),
                ...
                child: Stack(children: [
                  ...
                  Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Container(
                      ...
                      child: const Text('PEDAGANG', style: TextStyle(color: Colors.white,
            ...
            child: Padding(
              ...
              child: Column(children: [
                _sectionCard('Informasi Akun', Icons.person_rounded, [
                  ...
                  _divider(),
                  _infoRow(Icons.badge_outlined, 'Role', 'Pedagang'),
                ]),
